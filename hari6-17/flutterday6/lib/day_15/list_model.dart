...
import 'package:flutterday6/day_15/model/buah_model.dart';

class ListOfModelDay13 extends StatelessWidget {
  ListOfModelDay13({super.key});
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return ListTile(
            ...
            trailing: Text(dataProduk[index].harga),
          );
        },
      ),
    );
